...
public abstract class DummyGenerator {
    ...
    public static List<Meeting> dummyMeetings = Arrays.asList(
            ...
            new Meeting(2,new Room (2, "Réunion B", 0xFF6200EE), 1618571700000L, "Bastien", Arrays.asList("bastien@lamzone.com","fabien@lamzone.com"), "recyclage dechet"),
            ...
            new Meeting(4,new Room (4, "Réunion D", 0xFF03DAC5), 1618590600000L, "Vincent", Arrays.asList("vincent@lamzone.com","jerome@lamzone.com","rachel.d@gmail.com"), "Projet Turf"),
            ...
            new Meeting(6,new Room (6, "Réunion F", 0xFF000000), 1618567200000L, "Rachel", Arrays.asList("rachel@lamzone.com","philippe@lamzone.com"), "Organisation Team building"),
            ...
            new Meeting(8, new Room (8, "Réunion H", 0xFFFFEB3B), 1618585200000L, "Anne-Denise", Arrays.asList("anne@lamzone.com","victor@lamzone.com"), "Appel d'offre "),
            ...
            new Meeting(10,new Room (10, "Réunion J", 0xFF6AC34A), 1618596000000L, "Victor", Arrays.asList("victor@lamzone.com","bob@lamzone.com"), "Nouveaux clients")
    );
